<template>
	<div class="bg-white px-4 py-5  sm:px-6">
		<div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
			...
			<!-- 	<textarea id="about" name="about" rows="2" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm rounded-lg p-4 pr-28 overflow-hidden " v-bind:class="{ 'border-2 ring-red-500 border-red-500': req }" placeholder=""
